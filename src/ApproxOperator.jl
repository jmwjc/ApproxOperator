...
export set𝓖!
export set𝝭!, set∇𝝭!, set∇₁𝝭!, set∇₂𝝭!, set∇²𝝭!, set∇²₂𝝭!, set∇²₁𝝭!, set∇³𝝭!, set∇³₁𝝭!, set∇̃𝝭!, set∇̃²𝝭!, set∇∇̃²𝝭!, set∇̄𝝭!, set∇̄²𝝭!, set∇∇̄²𝝭!, set∇̂³𝝭!, set𝒏!, set∇𝑢!, get∇𝑢, get𝝐, set_memory_𝗠!, set_memory_𝝭!
